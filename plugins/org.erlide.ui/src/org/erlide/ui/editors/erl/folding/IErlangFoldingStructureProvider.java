...
/**
 * Contributors to the <code>org.eclipse.jdt.ui.foldingStructureProvider</code> extension
 * point must specify an implementation of this interface which will create and maintain
 * {@link org.eclipse.jface.text.source.projection.ProjectionAnnotation} objects that
 * define folded regions in the the
 ...
 * <code>IErlangFoldingStructureProvider</code>, extension interfaces are used to provide
...
public interface IErlangFoldingStructureProvider extends IErlModelChangeListener {
    ...
    /**
     * Installs this structure provider on the given editor and viewer. Implementations
     * should listen to the projection events generated by <code>viewer</code> and enable
     * / disable generation of projection structure accordingly.
     *
     * @param editor
