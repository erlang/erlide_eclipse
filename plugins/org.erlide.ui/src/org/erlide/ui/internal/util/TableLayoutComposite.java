...
/**
 * A special composite to layout columns inside a table. The composite is needed since we
 * have to layout the columns "before" the actual table gets layouted. Hence we can't use
 * a normal layout manager.
 */
