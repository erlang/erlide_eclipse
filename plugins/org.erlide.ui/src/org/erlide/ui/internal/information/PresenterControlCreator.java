...
public final class PresenterControlCreator
    ...
    private static final class BackAction extends Action {
        ...
        public void update() {
            ...
            if (current != null && current.getPrevious() != null) {
                final ErlangBrowserInformationControlInput previous = current
                        .getPrevious();
    ...
    private static final class OpenDeclarationAction extends Action {
        ...
        @Override
        public void run() {
            final ErlangBrowserInformationControlInput infoInput = fInfoControl
                    .getInput();
            fInfoControl.notifyDelayedInputChange(null);
            fInfoControl.dispose();
    ...
    protected IInformationControl doCreateInformationControl(final Shell parent) {
        if (ErlangBrowserInformationControl.isAvailable(parent)) {
            ...
            final ErlangBrowserInformationControl control = new ErlangBrowserInformationControl(
                    parent, font, tbm);
