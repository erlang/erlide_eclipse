...
public class ErlangProjectPropertyPage extends PropertyPage {
    ...
    protected Control createContents(final Composite parent) {
        ...
        composite.setLayout(new GridLayout(2, false));
        {
            ...
            lblRequiredErlangVersion.setLayoutData(
        ...
        }
        {
            ...
            runtimeCombo.addSelectionListener(new SelectionListener() {
                ...
                public void widgetSelected(final SelectionEvent e) {
                    model.setRequiredRuntimeVersion(
        ...
        new Label(composite, SWT.NONE);
        {
            ...
            lblExternalModules.setLayoutData(
                    new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
        ...
        }
        {
            ...
            extModsText
                    .setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
            extModsText.setEnabled(
                    globalEnable && SystemConfiguration.getInstance().isDeveloper());
            extModsText.setText(model.getExternalModulesFile());
        }
        {
            final Label lblExternalIncludes = new Label(composite, SWT.NONE);
            lblExternalIncludes.setLayoutData(
                    new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
