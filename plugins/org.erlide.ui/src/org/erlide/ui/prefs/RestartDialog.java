...
/**
 * A dialog which prompts the user to restart after an update operation and provides Yes,
 * No, Continue buttons.
 */
public class RestartDialog extends MessageDialog {
    private static final int CONTINUE = 2;
    private static final String[] yesNo = {
     ...
     *      org.eclipse.swt.graphics.Image, java.lang.String, int, java.lang.String[],
     *      int)
     */
