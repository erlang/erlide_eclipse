...
public class ProblemsLabelDecorator
    ...
    public static class ProblemsLabelChangedEvent extends LabelProviderChangedEvent {
        ...
        /**
         * Returns whether this event origins from marker changes. If <code>false</code>
         * an annotation model change is the origin. In this case viewers not displaying
         * working copies can ignore these events.
         *
    ...
    protected int computeAdornmentFlags(final Object obj) {
        try {
            final ISourceReference r = obj instanceof ISourceReference
                    ? (ISourceReference) obj
                    : null;
            if (obj instanceof IResource) {
                return ProblemsLabelDecorator.getErrorTicksFromMarkers((IResource) obj,
                        IResource.DEPTH_INFINITE, r);
            } else if (obj instanceof IErlElement) {
                final IErlElement e = (IErlElement) obj;
                return ProblemsLabelDecorator.getErrorTicksFromMarkers(e.getResource(),
                        IResource.DEPTH_INFINITE, r);
            }
     ...
     * @return boolean Return <code>true</code> if position is located inside the source
     *         element.
     * @throws CoreException
