    ...
    public ContextTypeRegistry getContextTypeRegistry() {
        if (fRegistry == null) {
            ...
            fRegistry.addContextType(
                    ErlangSourceContextTypeComment.ERLANGSOURCE_CONTEXT_TYPE_COMMENTS);
            fRegistry.addContextType(
                    ErlangSourceContextTypeComment.ERLANGSOURCE_CONTEXT_TYPE_BEHAVIOUR);
            fRegistry.addContextType(
                    ErlangSourceContextTypeComment.ERLANGSOURCE_CONTEXT_TYPE_LAYOUT);
        }
        return fRegistry;
    }
}
