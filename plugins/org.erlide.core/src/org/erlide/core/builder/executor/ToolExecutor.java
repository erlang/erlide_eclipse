...
public class ToolExecutor {
    ...
    public ToolResults run(final String cmd0, final String[] args, final String wdir,
            final ProgressCallback cb, final BuildNotifier bn) {
        final ToolResults result = new ToolResults();
