...
/**
 * Provides a Java representation of a cons cell (works for both lists and tuples!). A
 * list or tuple pattern can end with " | Variable", where the variable is matched against
