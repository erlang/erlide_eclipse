 ...
 * <p>
 * It serves as a single entry point to all functionality related to handling Erlang code.
 * This way it will be much easier to extract the engine and implement it in Erlang or to
 * let it be used by Xtext.
 * </p>
 */
