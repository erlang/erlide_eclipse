...
/**
 * An element changed listener receives notification of changes to Erlang elements
 * maintained by the Erlang model.
 * <p>
...
public interface IElementChangedListener {
    ...
    /**
     * Notifies that one or more attributes of one or more Erlang elements have changed.
