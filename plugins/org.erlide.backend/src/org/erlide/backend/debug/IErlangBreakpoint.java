...
public interface IErlangBreakpoint extends IBreakpoint {
    /**
     * Returns whether this breakpoint supports a conditional expression. Conditional
     * breakpoints only suspend when their associated condition evaluates to
     * <code>true</code>.
     *
     ...
     *                if unable to access the property on this breakpoint's underlying
     *                marker
     */
    String getCondition() throws CoreException;

    /**
     * Sets the condition associated with this breakpoint. When the condition is enabled,
     * this breakpoint will only suspend execution when the given condition evaluates to
     * <code>true</code>. Setting the condition to <code>null</code> or an empty string
     * removes the condition.
     * <p>
     * If this breakpoint does not support conditions, setting the condition has no
     * effect.
     * </p>
     *
     * @param condition
    ...
    /**
     * Sets the enabled state of this breakpoint's condition to the given state. When
     * enabled, this breakpoint will only suspend when its condition evaluates to true.
     * When disabled, this breakpoint will suspend as it would with no condition defined.
     *
     * @exception CoreException
     *                if unable to set the property on this breakpoint's underlying marker
     */
     ...
     * <code>true</code> or when the value of the condition changes.
     *
     * @return <code>true</code> if this breakpoint suspends when the value of the
     *         condition is <code>true</code>, <code>false</code> if this breakpoint
     ...
     * <code>true</code>, the breakpoint will stop when the value of the condition is
     * <code>true</code>. If the value is <code>false</code>, the breakpoint will stop
