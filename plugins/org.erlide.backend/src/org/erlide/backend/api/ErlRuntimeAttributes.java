...
public class ErlRuntimeAttributes {
    ...
    public static final String DEBUG_INTERPRET_MODULES = ErlRuntimeAttributes.PREFIX + ".interpretModules";
    ...
    public static final String LOAD_ALL_NODES = ErlRuntimeAttributes.PREFIX + ".loadAllNodes";
