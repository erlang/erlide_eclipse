...
public class PerformanceMonitorFactory {
     ...
     */
    public PerformanceMonitor findPerformanceMonitor(final String name) {
     ...
     *            the {@link PerformanceMonitor} to add.
     */
    protected void addPerformanceMonitorToMap(final String name,
