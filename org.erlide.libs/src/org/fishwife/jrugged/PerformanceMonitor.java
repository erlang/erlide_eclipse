...
public class PerformanceMonitor implements ServiceWrapper {
    ...
    private void createMovingAverages() {
        ...
        successRequestsPerSecondLastMinute = new MovingAverage(
                ONE_MINUTE_MILLIS);
        failureRequestsPerSecondLastMinute = new MovingAverage(
                ONE_MINUTE_MILLIS);
    ...
    private void recordSuccess(final LatencyTracker latencyTracker) {
        ...
        lifetimeMaxSuccessMillis = successMillis > lifetimeMaxSuccessMillis ? successMillis
    ...
    private void recordFailure(final LatencyTracker latencyTracker) {
        ...
        lifetimeMaxFailureMillis = failureMillis > lifetimeMaxFailureMillis ? failureMillis
