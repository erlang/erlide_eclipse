...
import org.erlide.erlc.internal.core.ProcessClosure;
...
public class CommandLauncher {
	...
	public int waitAndRead(OutputStream out, OutputStream err) {
		...
		final ProcessClosure closure = new ProcessClosure(fProcess, out, err);
	...
	public int waitAndRead(OutputStream output, OutputStream err,
		...
		final ProcessClosure closure = new ProcessClosure(fProcess, output, err);
		...
		if (monitor.isCanceled()) {
			...
			setErrorMessage("Command cancelled");
		}
	...
	protected void printCommandLine(OutputStream os) {
		if (os != null) {
			final String cmd = getCommandLine(getCommandArgs());
			try {
