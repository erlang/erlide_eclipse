...
public class ScrollLockAction extends Action {
	...
	public ScrollLockAction(BuildConsoleViewer viewer) {
		...
		setToolTipText(ConsoleMessages
				.getString("ScrollLockAction.Scroll_Lock_1")); //$NON-NLS-1$
		// FIXME CPluginImages.setImageDescriptors(this, CPluginImages.T_LCL,
		// CPluginImages.IMG_SCROLL_LOCK);
		setChecked(false);
	}
