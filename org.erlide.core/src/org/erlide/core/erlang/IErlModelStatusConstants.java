 ...
 */
public interface IErlModelStatusConstants {

	/**
	 * Status constant indicating that a classpath entry was invalid
	 */
	int INVALID_CODEPATH = 964;
	 ...
	 */
	int INVALID_CODEPATH_FILE_FORMAT = 1000;
	 ...
	 */
	int INCOMPATIBLE_ERTS_LEVEL = 1004;
