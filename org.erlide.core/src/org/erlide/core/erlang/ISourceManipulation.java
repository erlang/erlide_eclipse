...
/**
 * Common protocol for Erlang elements that support source code manipulations
...
public interface ISourceManipulation {
     ...
     */
    void copy(IErlElement container, IErlElement sibling, String rename,
     ...
     *                if container is <code>null</code>
     */
    void move(IErlElement container, IErlElement sibling, String rename,
            boolean replace, IProgressMonitor monitor) throws ErlModelException;
