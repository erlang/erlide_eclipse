 ...
 * read-only.
 * <p>
 * Note that Erlang model operations that manipulate an <code>IBuffer</code>
 * (for example, <code>IErlModule.createFunction(...)</code>) ensures that
 * the same line delimiter (either <code>"\n"</code> or <code>"\r"</code> or
...
public interface IBuffer {
	...
	/**
	 * Returns the Erlang openable element owning of this buffer.
	 * 
