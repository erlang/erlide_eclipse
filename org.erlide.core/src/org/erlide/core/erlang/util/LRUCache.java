 ...
 * 
 * @see org.erlide.core.erlang.internal.util.ILRUCacheable
 */
public class LRUCache implements Cloneable {
	...
	public Object clone() throws CloneNotSupportedException {
		...
		final LRUCache newCache = newInstance(fSpaceLimit);
	...
	public Object removeKey(Object key) {
		...
		final Object value = entry._fValue;
		this.privateRemoveEntry(entry, false);
		return value;
	}
	...
	protected String toStringContents() {
		...
		for (int i = 0; i < length; i++) {
			...
			final String toString = unsortedToStrings[i];
			final Object value = this.get(unsortedKeys[i]);
