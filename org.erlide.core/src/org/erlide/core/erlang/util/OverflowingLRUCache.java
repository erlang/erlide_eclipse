 ...
 * @see LRUCache
 */
abstract public class OverflowingLRUCache extends LRUCache {
	...
	public Object clone() {
		...
		final OverflowingLRUCache newCache = (OverflowingLRUCache) newInstance(
	...
	public Enumeration elements() {
		...
		final LRUCacheEnumerator.LRUEnumeratorElement head = new LRUCacheEnumerator.LRUEnumeratorElement(
				fEntryQueue._fValue);
	...
	protected void privateRemoveEntry(LRUCacheEntry entry, boolean shuffle,
		...
		final LRUCacheEntry previous = entry._fPrevious;
		final LRUCacheEntry next = entry._fNext;
	...
	public Object put(Object key, Object value) {
		...
		if (entry != null) {
			 ...
			 * cache within budget
			 */
			final int oldSpace = entry._fSpace;
			final int newTotal = fCurrentSpace - oldSpace + newSpace;
