...
public class ErlideDebug {
    ...
    public static OtpErlangList getProcesses(final ErlCallable backend,
    ...
    @SuppressWarnings("boxing")
    public static OtpErlangPid startDebug(final ErlCallable backend,
     ...
     */
    public static OtpErlangPid attached(final ErlCallable backend,
    ...
    public static OtpErlangObject getProcessInfo(final ErlCallable backend,
    ...
    public static boolean isErlideProcess(final ErlCallable backend,
    ...
    @SuppressWarnings("boxing")
    public static boolean interpret(final ErlCallable backend, final String module,
    ...
    public static boolean isSystemProcess(final ErlCallable backend,
            final OtpErlangPid pid) {
        boolean res = false;
        try {
            final OtpErlangAtom eres = (OtpErlangAtom) backend.call(
    ...
    @SuppressWarnings("boxing")
    public static void addDeleteLineBreakpoint(final ErlCallable backend,
    ...
    public static void sendStarted(final ErlCallable backend,
    ...
    public static void resume(final ErlCallable backend, final OtpErlangPid meta) {
        try {
    ...
    public static void suspend(final ErlCallable backend, final OtpErlangPid meta) {
        try {
    ...
    public static OtpErlangList getBindings(final ErlCallable backend,
            final OtpErlangPid meta) {
        try {
            final OtpErlangObject res = backend.call("erlide_debug",
                    "bindings", "x", meta);
    ...
    public static void stepOver(final ErlCallable backend, final OtpErlangPid meta) {
        try {
    ...
    public static void stepReturn(final ErlCallable backend, final OtpErlangPid meta) {
        try {
    ...
    public static void stepInto(final ErlCallable backend, final OtpErlangPid meta) {
        try {
    ...
    public static OtpErlangTuple getAllStackframes(final ErlCallable backend,
            final OtpErlangPid meta) {
        try {
            final OtpErlangObject res = backend.call("erlide_debug",
    ...
    public static List<String> getAllModulesOnStack(final ErlCallable backend,
            final OtpErlangPid meta) {
        try {
            final OtpErlangObject res = backend.call("erlide_debug",
    ...
    @SuppressWarnings("boxing")
    public static OtpErlangTuple tracing(final ErlCallable backend,
    ...
    public static OtpErlangObject eval(final ErlCallable backend,
    ...
    @SuppressWarnings("boxing")
    public static String setVariableValue(final ErlCallable backend,
    ...
    public static OtpErlangObject distributeDebuggerCode(final ErlCallable backend,
    ...
    public static OtpErlangList nodes(final ErlCallable backend) {
        try {
    ...
    public static boolean dropToFrame(final ErlCallable backend,
