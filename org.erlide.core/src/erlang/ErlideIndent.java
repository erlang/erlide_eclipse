...
public class ErlideIndent {
    ...
    public static IndentResult indentLine(final ErlCallable b,
    ...
    @SuppressWarnings("boxing")
    public static OtpErlangObject indentLines(final ErlCallable b,
    ...
    public static OtpErlangObject templateIndentLines(final ErlCallable b,
    ...
    @SuppressWarnings("boxing")
    public static OtpErlangObject call(final ErlCallable b, final String module,
