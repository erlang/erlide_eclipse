...
public class ErlideProclist {
    ...
    public static void processListInit(final IRpcSite b) {
        if (b == null) {
            return;
        }
        try {
    ...
    public static OtpErlangList getProcessList(final IRpcSite b) {
        if (b == null) {
    ...
    public static OtpErlangObject getProcessInfo(final IRpcSite b,
