...
/**
 * Double click strategy aware of Erlang identifier syntax rules.
 */
public class ErlDoubleClickSelector implements ITextDoubleClickStrategy {
	...
	public ErlDoubleClickSelector(ErlPairMatcher bracketMatcher) {
		fPairMatcher = bracketMatcher;
	}
