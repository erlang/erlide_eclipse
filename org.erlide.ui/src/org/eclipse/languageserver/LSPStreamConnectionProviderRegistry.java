 ...
 * {@link StreamConnectionProvider}
 * for a given input.
 * At the moment, registry content is hardcoded but we'll very soon need a way
 * to contribute to it via plugin.xml (for plug-in developers) and from Preferences
