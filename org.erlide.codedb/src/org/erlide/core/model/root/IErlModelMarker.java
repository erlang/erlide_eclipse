...
public interface IErlModelMarker {
     ...
     */
    String ERLANG_MODEL_PROBLEM_MARKER = CodeDbPlugin.PLUGIN_ID + ".problem"; //$NON-NLS-1$
     ...
     */
    String TRANSIENT_PROBLEM = CodeDbPlugin.PLUGIN_ID + ".transient_problem"; //$NON-NLS-1$
     ...
     * 
     */
    String TASK_MARKER = CodeDbPlugin.PLUGIN_ID + ".task"; //$NON-NLS-1$
     ...
     */
    String BUILDPATH_PROBLEM_MARKER = CodeDbPlugin.PLUGIN_ID
     ...
     * detected by the Erlang tooling during classpath setting.
     */
    String PATHENTRY_PROBLEM_MARKER = CodeDbPlugin.PLUGIN_ID
