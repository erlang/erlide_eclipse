...
public class ErlModelStatus extends Status implements IErlModelStatus {
    ...
    public ErlModelStatus() {
        ...
        super(ERROR, CodeDbPlugin.PLUGIN_ID, 0, "ErlModelStatus", null); //$NON-NLS-1$
    }
    ...
    public ErlModelStatus(final int code) {
        super(ERROR, CodeDbPlugin.PLUGIN_ID, code, "ErlModelStatus", null); //$NON-NLS-1$
    ...
    public ErlModelStatus(final int severity, final int code,
            final String string) {
        super(severity, CodeDbPlugin.PLUGIN_ID, code, "ErlModelStatus", null); //$NON-NLS-1$
        fElements = NO_ELEMENTS;
        fPath = null;
        fString = string;
    }
    ...
    public ErlModelStatus(final int code, final Throwable throwable) {
        super(ERROR, CodeDbPlugin.PLUGIN_ID, code, "ErlModelStatus", throwable); //$NON-NLS-1$
        fElements = NO_ELEMENTS;
    }
    ...
    public ErlModelStatus(final CoreException coreException) {
        super(ERROR, CodeDbPlugin.PLUGIN_ID,
