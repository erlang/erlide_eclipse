...
import org.erlide.basicui.internal.util.TableLayoutComposite;
...
public class ListDialogField<Element> extends DialogField {
	...
	private void moveUp(List<Element> toMoveUp) {
		if (toMoveUp.size() > 0) {
	...
	private void moveDown(List<Element> toMoveDown) {
	...
	private List<Element> reverse(List<Element> p) {
