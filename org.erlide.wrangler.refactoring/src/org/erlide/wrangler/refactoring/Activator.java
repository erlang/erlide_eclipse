...
public class Activator extends AbstractUIPlugin {
	 ...
	 */
	/*
	 * private void initWrangler() throws CoreException { try { Path pluginPath
	 * = getPluginPath(); IPath wranglerRootPath =
	 * pluginPath.append("wrangler"); String wranglerEbinPath =
	 * wranglerRootPath.append("ebin") .toOSString(); String wranglerAppPath =
	 * wranglerRootPath.append("app") .toOSString();
	 * 
	 * String wranglerSrcPath = wranglerRootPath.append("erl") .toOSString();
	 * 
	 * ErlLogger .debug("Wrangler beam files found at: " + wranglerEbinPath);
	 * 
	 ...
	 * application:start(wrangler_app) res = mb.call_noexception("application",
	 * "start", "a", "wrangler_app");
	 * 
