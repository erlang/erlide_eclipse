...
public final class GUnitMessages extends NLS {

	private static final String BUNDLE_NAME = "org.erlide.gunit.internal.ui.JUnitMessages";//$NON-NLS-1$
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, GUnitMessages.class);
	}

	private GUnitMessages() {
		// Do not instantiate
	}
