...
public class DuplicatedCodeInstanceElement extends AbstractResultTreeObject {
	 ...
	 */
	public DuplicatedCodeInstanceElement(final IFile containingFile, final int startLine, final int startColumn,
		...
		try {
			startOffset = WranglerUtils.calculateOffsetFromPosition(startLine, startColumn, doc);
			endOffset = WranglerUtils.calculateOffsetFromPosition(endLine, endColumn, doc);
