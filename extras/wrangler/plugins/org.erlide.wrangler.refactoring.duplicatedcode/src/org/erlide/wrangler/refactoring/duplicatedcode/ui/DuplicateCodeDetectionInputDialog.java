...
public class DuplicateCodeDetectionInputDialog extends AbstractInputDialog {
	 ...
	 *            dialog title
	 */
	public DuplicateCodeDetectionInputDialog(final Shell parentShell, final String dialogTitle) {
	...
	protected Control createDialogArea(final Composite parent) {
		...
		onlyInFileCheckBoxButton.setLayoutData(new GridData(GridData.GRAB_HORIZONTAL | GridData.HORIZONTAL_ALIGN_FILL));
